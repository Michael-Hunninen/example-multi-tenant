...
export default async function Page({
  ...
  // Check if we're in draft mode for LivePreview
  ...
  const pageQuery = await payload.find({
    ...
    depth: 2, // Increase depth to ensure related content is fetched
    draft: isDraftMode, // Enable draft mode if we're in draft mode
  })
